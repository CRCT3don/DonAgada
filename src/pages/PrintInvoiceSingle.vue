...
export default {
  ...
  create() {
    this.resavationHistory = JSON.parse(localStorage.getItem('details'))
  },

  computed: {
    sortEvents() {
      return this.reservationHistory.find((ticket) => ticket.id === this.$route.params.id
      )
    }
  },
